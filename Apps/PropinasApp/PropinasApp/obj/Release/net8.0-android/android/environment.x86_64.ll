...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 4083574733475246986, ; hash 0x38abc5959a8d738a, from name: libaot-PropinasApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PropinasApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 103
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4942946164742378414, ; hash 0x4498df59155953ae, from name: libaot-PropinasApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PropinasApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 121
	...
	%struct.DSOCacheEntry {
		i64 7200882027198303954, ; hash 0x63eeac0d44a64ed2, from name: aot-PropinasApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PropinasApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 163
	...
	%struct.DSOCacheEntry {
		i64 13623942880999567579, ; hash 0xbd11f7de1630f0db, from name: aot-PropinasApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PropinasApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 352
	...
	%struct.DSOCacheEntry {
		i64 16881987251818566822, ; hash 0xea48ddf5ff5194a6, from name: PropinasApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PropinasApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 440
	...
	%struct.DSOCacheEntry {
		i64 17733152806086009251, ; hash 0xf618d085da7a61a3, from name: PropinasApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PropinasApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 457
...
@.env.3 = private unnamed_addr constant [37 x i8] c"bdda9459-8c31-495b-99c8-14e5d60ab501\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.propinasapp\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [26 x i8] c"libaot-PropinasApp.dll.so\00", align 16
