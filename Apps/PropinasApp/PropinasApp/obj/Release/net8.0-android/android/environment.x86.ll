...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 641004127, ; hash 0x2634f25f, from name: libaot-PropinasApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 712213445, ; hash 0x2a7383c5, from name: aot-PropinasApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PropinasApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 70
	...
	%struct.DSOCacheEntry {
		i64 1726455362, ; hash 0x66e79e42, from name: PropinasApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PropinasApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 179
	...
	%struct.DSOCacheEntry {
		i64 2493486421, ; hash 0x949f9555, from name: PropinasApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PropinasApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 278
	...
	%struct.DSOCacheEntry {
		i64 3113466390, ; hash 0xb993ba16, from name: aot-PropinasApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PropinasApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 361
	...
	%struct.DSOCacheEntry {
		i64 4221368575, ; hash 0xfb9cf8ff, from name: libaot-PropinasApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PropinasApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 473
