...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 813310935, ; hash 0x307a23d7, from name: PrimitivaApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1099637621, ; hash 0x418b2375, from name: libaot-PrimitivaApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimitivaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 116
	...
	%struct.DSOCacheEntry {
		i64 1894295410, ; hash 0x70e8a772, from name: PrimitivaApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimitivaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 198
	...
	%struct.DSOCacheEntry {
		i64 2491200879, ; hash 0x947cb56f, from name: aot-PrimitivaApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimitivaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 278
	...
	%struct.DSOCacheEntry {
		i64 2738232900, ; hash 0xa3361e44, from name: libaot-PrimitivaApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimitivaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 310
	...
	%struct.DSOCacheEntry {
		i64 3354400287, ; hash 0xc7f0161f, from name: aot-PrimitivaApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimitivaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 383
