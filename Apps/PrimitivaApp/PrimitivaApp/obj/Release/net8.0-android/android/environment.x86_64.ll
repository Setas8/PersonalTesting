...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1887549731511056635, ; hash 0x1a31ec7aea99b8fb, from name: libaot-PrimitivaApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimitivaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 39
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5018689740179045720, ; hash 0x45a5f7ba8144fd58, from name: libaot-PrimitivaApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimitivaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 121
	...
	%struct.DSOCacheEntry {
		i64 8969559507804988389, ; hash 0x7c7a46d97e71a3e5, from name: aot-PrimitivaApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimitivaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 227
	...
	%struct.DSOCacheEntry {
		i64 10287363087075268796, ; hash 0x8ec40e39109658bc, from name: aot-PrimitivaApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimitivaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 258
	...
	%struct.DSOCacheEntry {
		i64 13140499416870424895, ; hash 0xb65c6e9929ca113f, from name: PrimitivaApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimitivaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 340
	...
	%struct.DSOCacheEntry {
		i64 18173051999166561349, ; hash 0xfc33a6821f067c45, from name: PrimitivaApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimitivaApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 468
...
@.env.3 = private unnamed_addr constant [37 x i8] c"7d779b94-9a7e-4a6b-a850-2fc9f5f2cfde\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.companyname.primitivaapp\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [27 x i8] c"libaot-PrimitivaApp.dll.so\00", align 16
